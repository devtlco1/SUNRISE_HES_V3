"""Explicit read-obis-selection on staged inbound modem TCP socket."""
...
def execute_tcp_listener_read_obis_selection(
    ...
    try:
        with ctl.session_context():
            try:
                ...
                try:
                    log.info(
                        "tcp_listener_read_obis_selection_start",
                        extra={
                    ...
                    envelope = adapter.read_obis_selection_on_accepted_tcp_socket(
