...
- **Python sidecar:** `apps/runtime-python/` (FastAPI — direct reads + **discover-supported-obis** under `/v1/runtime/*`, async jobs under `/v1/jobs/*`; discovery doc: `docs/runtime-python-discovery.md`).
