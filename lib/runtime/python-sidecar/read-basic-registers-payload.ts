...
import type { ReadBasicRegistersRequest } from "@/types/runtime"

/** JSON body forwarded to Python (extends runtime target with optional channel spec). */
export type PythonReadBasicRegistersRequest = ReadBasicRegistersRequest & {
  channel?: Record<string, unknown>
}

export function parsePythonReadBasicRegistersRequest(
  body: unknown
): PythonReadBasicRegistersRequest | null {
